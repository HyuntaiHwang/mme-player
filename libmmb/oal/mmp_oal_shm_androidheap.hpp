...
#ifndef MMP_OAL_SHM_ANDROIDHEAP_HPP__
#define MMP_OAL_SHM_ANDROIDHEAP_HPP__

#include "mmp_oal_shm.hpp"

class mmp_oal_shm_androidheap : public mmp_oal_shm {
...
protected:
	...
	mmp_oal_shm_androidheap(struct mmp_oal_shm_create_config* p_create_config);
	virtual ~mmp_oal_shm_androidheap();
