...
static int compare_mem_table_structs(const void *a, const void *b){
    ...
    //MMPDEBUGMSG(1, (TEXT("[compare_mem_table_structs] %s %s"),  ((const mem_table_struct*)a)->name,((const mem_table_struct*)b)->name ));
...
static struct mmp_system_meminfo s_system_meminfo;
...
void mmp_system_meminfo(struct mmp_system_meminfo* p_meminfo) {
  ...
  static const mem_table_struct mem_table[] = {
    {"Active",     &s_system_meminfo.Active},
    {"Active(anon)",   &s_system_meminfo.Active_anon},
    {"Active(file)",    &s_system_meminfo.Active_file},
    {"AnonPages",       &s_system_meminfo.AnonPages},
    {"Bounce",          &s_system_meminfo.Bounce},
    {"Buffers",   &s_system_meminfo.Buffers},
    {"Cached",    &s_system_meminfo.Cached},
    {"CommitLimit",     &s_system_meminfo.CommitLimit},
    {"Committed_AS",    &s_system_meminfo.Committed_AS},
    {"Dirty",           &s_system_meminfo.Dirty},
    {"HighFree",        &s_system_meminfo.HighFree},
    {"HighTotal",       &s_system_meminfo.HighTotal},
    {"Inactive",      &s_system_meminfo.Inactive},
    {"Inactive(anon)",  &s_system_meminfo.Inactive_anon},
    {"Inactive(file)",  &s_system_meminfo.Inactive_file},
    {"KernelStack",     &s_system_meminfo.KernelStack},
    {"LowFree",         &s_system_meminfo.LowFree},
    {"LowTotal",        &s_system_meminfo.LowTotal},
    {"Mapped",          &s_system_meminfo.Mapped},
    {"MemFree",   &s_system_meminfo.MemFree},
    {"MemTotal",   &s_system_meminfo.MemTotal},
    {"Mlocked",         &s_system_meminfo.Mlocked},
    {"NFS_Unstable",    &s_system_meminfo.NFS_Unstable},
    {"PageTables",      &s_system_meminfo.PageTables},
    {"Shmem",           &s_system_meminfo.Shmem},
    {"Slab",            &s_system_meminfo.Slab},
    {"SwapCached",  &s_system_meminfo.SwapCached},
    {"SwapFree",        &s_system_meminfo.SwapFree},
    {"SwapTotal",       &s_system_meminfo.SwapTotal},
    {"SReclaimable",    &s_system_meminfo.SReclaimable},
    {"SUnreclaim",      &s_system_meminfo.SUnreclaim},
    {"Unevictable",     &s_system_meminfo.Unevictable},
    {"VmallocChunk",    &s_system_meminfo.VmallocChunk},
    {"VmallocTotal",    &s_system_meminfo.VmallocTotal},
    {"VmallocUsed",     &s_system_meminfo.VmallocUsed},
    {"Writeback",       &s_system_meminfo.Writeback},
    {"WritebackTmp",    &s_system_meminfo.WritebackTmp},
  ...
  for(;;){
    ...
    *tail = '\0';
    ...
    //MMPDEBUGMSG(1, (TEXT("ln: %d head : %s "), __LINE__, head ));
    ...
    //MMPDEBUGMSG(1, (TEXT("ln: %d  namebuf : %s found: 0x%08x "), __LINE__,found));
    ...
    *(found->slot) = strtoul(head,&tail,10);
    ...
    //MMPDEBUGMSG(1, (TEXT("ln: %d head : %s  slot: %d  "), __LINE__, head , *(found->slot)));
...
nextline:
  ...
  memcpy(p_meminfo, &s_system_meminfo, sizeof(s_system_meminfo));
