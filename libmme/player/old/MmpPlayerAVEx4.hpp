...
#ifndef MMPPLAYERAVEX4_HPP__
#define MMPPLAYERAVEX4_HPP__
...
#define CMmpPlayerAVEx4_DEMUX_TASK_ADD_AUDIO_DATA_ENABLE 1
#define CMmpPlayerAVEx4_DEMUX_TASK_ADD_VIDEO_DATA_ENABLE 1
#define CMmpPlayerAVEx4_AUDIO_DEC_TASK_ADD_PCM_ENABLE 1

class CMmpPlayerAVEx4 : public CMmpPlayer
{
...
protected:
    CMmpPlayerAVEx4(CMmpPlayerCreateProp* pPlayerProp);
    virtual ~CMmpPlayerAVEx4();
