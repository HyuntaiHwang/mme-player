...
#ifndef MMPRENDERER_ANDROIDSURFACEEX3_HPP__
#define MMPRENDERER_ANDROIDSURFACEEX3_HPP__
...
class CMmpRenderer_AndroidSurfaceEx3 : public CMmpRendererVideo
{
...
private:
    ...
    int m_queue_count;
    bool m_is_api_connect;
    
protected:
    CMmpRenderer_AndroidSurfaceEx3(struct CMmpRendererVideo::create_config* p_create_config);
    virtual ~CMmpRenderer_AndroidSurfaceEx3();
