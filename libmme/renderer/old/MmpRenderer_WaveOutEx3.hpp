...
#ifndef _MMPRENDERER_WAVEOUTEX3_HPP__
#define _MMPRENDERER_WAVEOUTEX3_HPP__
...
class CMmpRenderer_WaveOutEx3 : public CMmpRendererAudio
{
...
protected:
    CMmpRenderer_WaveOutEx3(struct CMmpRendererAudio::create_config *p_create_config);
    virtual ~CMmpRenderer_WaveOutEx3();
