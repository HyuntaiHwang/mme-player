...
MMP_U32 CMmpRenderer_Dummy::m_render_file_id = 0;

CMmpRenderer_Dummy::CMmpRenderer_Dummy(struct CMmpRendererVideo::create_config* p_create_config) :  CMmpRendererVideo(p_create_config)
{
...
MMP_RESULT CMmpRenderer_Dummy::Init_Renderer(MMP_S32 pic_width, MMP_S32 pic_height)
{
    ...
    CMmpRenderer_Dummy::m_render_file_id++;

    return mmpResult;
}

MMP_RESULT CMmpRenderer_Dummy::vf_config_internal(MMP_S32 bufcnt, MMP_S32 pic_width, MMP_S32 pic_height, struct mmp_rect display_crop_rect) {
...
void CMmpRenderer_Dummy::SetFirstRenderer() {

    //MMPDEBUGMSG(1, (TEXT("[%s::%s] "), MMP_CLASS_NAME, MMP_CLASS_FUNC ));
}

void CMmpRenderer_Dummy::SetRotate(enum MMP_ROTATE rotate) {
    //MMPDEBUGMSG(1, (TEXT("[%s::%s] "), MMP_CLASS_NAME, MMP_CLASS_FUNC ));
}
...
MMP_RESULT CMmpRenderer_Dummy::Render(class mmp_buffer_videoframe* p_buf_vf, MMP_MEDIA_ID decoder_id) {
