...
#ifndef MMPRENDERER_DUMMYVIDEO_HPP__
#define MMPRENDERER_DUMMYVIDEO_HPP__

#include "MmpRendererVideo.hpp"

class CMmpRenderer_DummyVideo : public CMmpRendererVideo
{
...
protected:
    CMmpRenderer_DummyVideo(struct CMmpRendererVideo::create_config* p_create_config);
    virtual ~CMmpRenderer_DummyVideo();
