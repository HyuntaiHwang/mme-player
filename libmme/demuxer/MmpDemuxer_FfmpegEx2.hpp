...
#ifndef _MMPDEMUXER_FFMPEG_EX2_HPP__
#define _MMPDEMUXER_FFMPEG_EX2_HPP__
...
class CMmpDemuxer_FfmpegEx2 : public CMmpDemuxer
{
...
private:
    ...
    int64_t m_audio_last_ts;
    int64_t m_video_last_ts;

protected:
    CMmpDemuxer_FfmpegEx2(struct MmpDemuxerCreateConfig* pCreateConfig);
    virtual ~CMmpDemuxer_FfmpegEx2();
