...
#ifndef MMPENCODERFFMPEGEX1_HPP__
#define MMPENCODERFFMPEGEX1_HPP__
...
protected:
    CMmpEncoderFfmpegEx1();
    virtual ~CMmpEncoderFfmpegEx1();
...
public:
    virtual MMP_RESULT EncodeDSI(CMmpEncoderFfmpegEx1::config *p_encodr_config);
};
