...
#ifndef MMPMUXER_FFMPEG_EX2_HPP__
#define MMPMUXER_FFMPEG_EX2_HPP__
...
class CMmpMuxer_FfmpegEx2 : public CMmpMuxer
{
...
protected:
    CMmpMuxer_FfmpegEx2(struct MmpMuxerCreateConfig* pCreateConfig);
    virtual ~CMmpMuxer_FfmpegEx2();
