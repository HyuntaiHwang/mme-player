...
#ifndef _MMPDECODERAUDIO_FFMPEGEX2_HPP__
#define _MMPDECODERAUDIO_FFMPEGEX2_HPP__
...
class CMmpDecoderAudio_FfmpegEx2 : public CMmpDecoderAudio, CMmpDecoderFfmpegEx1
{
...
protected:
    CMmpDecoderAudio_FfmpegEx2(struct CMmpDecoderAudio::create_config *p_create_config);
    virtual ~CMmpDecoderAudio_FfmpegEx2();
