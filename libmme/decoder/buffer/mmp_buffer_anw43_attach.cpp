...
/* Andorid 4.3  Native Window Buffer */

mmp_buffer_anw43_attach::mmp_buffer_anw43_attach(struct mmp_buffer_create_config *p_create_config) : mmp_buffer(p_create_config)

{
    
}

mmp_buffer_anw43_attach::~mmp_buffer_anw43_attach() {

}

MMP_RESULT mmp_buffer_anw43_attach::open() {
...
MMP_RESULT mmp_buffer_anw43_attach::close() {
