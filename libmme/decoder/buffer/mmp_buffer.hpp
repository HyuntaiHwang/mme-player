...
public:
    ...
    mmp_buffer_addr(MMP_ADDR vir_addr, MMP_ADDR phy_addr, MMP_S32 size, MMP_S32 shared_fd) : m_vir_addr(vir_addr), m_phy_addr(phy_addr), m_size(size), m_shared_fd(shared_fd) { }
...
struct mmp_buffer_create_config {
    ...
    MMP_ADDR attach_phy_addr;
    MMP_ADDR attach_vir_addr;
    MMP_S32 attach_offset;

    MMP_U32 flag;
    MMP_U32 ion_heap_type;
};
...
public:
    enum {
        ION = 0,  /* Linux ION Buffer */
        ION_ATTACH,
        HEAP,     /* Applicaton Heap, generated by mallock */
        HEAP_ATTACH,
        META,
        ANDROID_NATIVE_WINDOW,  /* Android Native Window Buffer */
        ANDROID_NATIVE_WINDOW_ATTACH,
        TYPE_MAX
    };
...
protected:
    MMP_ADDR get_phy_addr_from_shared_fd(MMP_S32 shared_fd);
    MMP_ADDR get_vir_addr_from_phy_addr(MMP_U32 phy_addr, MMP_S32 size);

public:
    virtual MMP_ADDR get_phy_addr() { return m_buf_addr.m_phy_addr;}
    virtual MMP_ADDR get_vir_addr() { return m_buf_addr.m_vir_addr;}
    ...
    inline MMP_BOOL is_cached() { return ((m_create_config.flag&mmp_buffer::FLAG_CACHED)!=0)?MMP_TRUE:MMP_FALSE; }
};
