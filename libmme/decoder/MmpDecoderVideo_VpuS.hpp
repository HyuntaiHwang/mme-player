...
#ifndef MMPDECODERVIDEO_VPUS_HPP__
#define MMPDECODERVIDEO_VPUS_HPP__
...
class CMmpDecoderVideo_VpuS : public CMmpDecoderVideo, CLASS_DECODER_VPU
{
...
private:
    CMmpDecoderVideo_VpuS(struct CMmpDecoderVideo::create_config *p_create_config);
    virtual ~CMmpDecoderVideo_VpuS();
