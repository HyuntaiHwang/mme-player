...
MMP_BOOL CMmpDecoderVideo_Vpu::CheckSupportCodec(enum MMP_FOURCC fourcc_in) {
...
CMmpDecoderVideo_Vpu::CMmpDecoderVideo_Vpu(struct CMmpDecoderVideo::create_config *p_create_config) : 
...
MMP_RESULT CMmpDecoderVideo_Vpu::DecodeAu(class mmp_buffer_videostream* p_buf_vs, class mmp_buffer_videoframe** pp_buf_vf, MMP_BOOL *is_reconfig) {
...
MMP_RESULT CMmpDecoderVideo_Vpu::do_csc(class mmp_buffer_videoframe* p_buf_vf_vpu, class mmp_buffer_videoframe* p_buf_vf_decoded) {
    ...
    if( (pic_width < 640) && (pic_height < 480) )  b_hw = MMP_FALSE;
    if( (pic_width > 1024) && (pic_height > 768) )  b_hw = MMP_FALSE;
...
#if 1
MMP_RESULT CMmpDecoderVideo_Vpu::do_csc_hw(class mmp_buffer_videoframe* p_buf_vf_vpu, class mmp_buffer_videoframe* p_buf_vf_decoded) {
...
MMP_RESULT CMmpDecoderVideo_Vpu::do_csc_sw(class mmp_buffer_videoframe* p_buf_vf_vpu, class mmp_buffer_videoframe* p_buf_vf_decoded) {
...
MMP_RESULT CMmpDecoderVideo_Vpu::do_csc_mscaler_test(class mmp_buffer_videoframe* p_buf_vf_vpu, class mmp_buffer_videoframe* p_buf_vf_decoded) {
...
MMP_RESULT CMmpDecoderVideo_Vpu::DecodeAu(class mmp_buffer_videostream* p_buf_vs, class mmp_buffer_videoframe* p_buf_vf) {
...
#if (CSC_HW==CSC_HW_V4L2)
            this->do_csc_hw(p_buf_vf_vpu, p_buf_vf);
#elif (CSC_HW==CSC_HW_MSCALER)
            this->do_csc_mscaler_test(p_buf_vf_vpu, p_buf_vf);
#else
