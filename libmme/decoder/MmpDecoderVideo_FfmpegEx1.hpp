...
#ifndef MMPDECODERVIDEO_FFMPEGEX1_HPP__
#define MMPDECODERVIDEO_FFMPEGEX1_HPP__
...
class CMmpDecoderVideo_FfmpegEx1 : public CMmpDecoderVideo, CMmpDecoderFfmpegEx1
{
...
protected:
    CMmpDecoderVideo_FfmpegEx1(struct CMmpDecoderVideo::create_config *p_create_config);
    virtual ~CMmpDecoderVideo_FfmpegEx1();
