...
#ifndef _MMPDECODERAUDIO_FFMPEGEX3_HPP__
#define _MMPDECODERAUDIO_FFMPEGEX3_HPP__
...
class CMmpDecoderAudio_FfmpegEx3 : public CMmpDecoderAudio, CMmpDecoderFfmpegEx1
{
...
private:
    ...
    struct AVAudioResampleContext* m_pAVAudioResampleContext;
    
    //TCircular_Queue<struct audio_decoded_packet*> m_queue_decoded;
    
protected:
    CMmpDecoderAudio_FfmpegEx3(struct CMmpDecoderAudio::create_config *p_create_config);
    virtual ~CMmpDecoderAudio_FfmpegEx3();
    ...
    void AudioConvert_ProcessingEx1(MMP_TICKS uiTimeStamp, AVFrame *pAVFrame_Decoded, AVCodecContext *pAVCodecContext, class mmp_buffer_audioframe *p_buf_af);
