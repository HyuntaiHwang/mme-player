...
#ifndef MMP_VPU_IF_ANA_HPP__
#define MMP_VPU_IF_ANA_HPP__

#include "mmp_vpu_if.hpp"
#include "vpu.h"

class mmp_vpu_if_ana : public mmp_vpu_if {

friend class mmp_vpu_if;

private:
    
protected:
    
	mmp_vpu_if_ana(struct mmp_vpu_if_create_config* p_create_config);
	virtual ~mmp_vpu_if_ana();
