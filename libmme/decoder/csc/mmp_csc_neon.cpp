...
MMP_RESULT mmp_csc_neon::open() {

    return MMP_SUCCESS;
}

MMP_RESULT mmp_csc_neon::close() {

    return MMP_SUCCESS;
}
    
MMP_RESULT mmp_csc_neon::convert(class mmp_buffer_videoframe* p_buf_vf_src, class mmp_buffer_videoframe* p_buf_vf_dst) {
    ...
    CMmpImageTool::ConvertRGBtoYUV420M_neon_ex1((MMP_U8*)p_buf_vf_src->get_buf_vir_addr(), 
